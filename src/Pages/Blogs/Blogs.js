        ...
        <div className="max-w-md p-6 overflow-hidden rounded-lg shadow bg-gray-50 text-gray-800 border border-gray-300">
          <article>
            ...
            <p className="mt-4 text-gray-600">
              ...
              a KeyValue store <br />
              3. SQL databases are table-based on the other hand NoSQL databases
        ...
        <div className="max-w-md p-6 overflow-hidden rounded-lg shadow bg-gray-50 text-gray-800 border border-gray-300">
          <article>
            ...
            <p className="mt-4 text-gray-600">
              ...
              public key pair by the Identity Provider(IdP). User sign-in using
              ...
              token using the secret salt/ public key <br />A JSON Web Token
              consists of 3 parts separated by a period. Header, Payload,
              Signature
            </p>
          </article>
        </div>
        <div className="max-w-md p-6 overflow-hidden rounded-lg shadow bg-gray-50 text-gray-800 border border-gray-300">
          <article>
            ...
            <p className="mt-4 text-gray-600">
              ...
              5. Javascript can only run in the browsers. We can run Javascript
        ...
        <div className="max-w-md p-6 overflow-hidden rounded-lg shadow bg-gray-50 text-gray-800 border border-gray-300">
          <article>
            ...
            <p className="mt-4 text-gray-600">
              ...
              NodeJS cluster module or worker_threads module. A single instance
              of Node.js runs in a single thread. If you have a multi-core
              system then you can utilize every core. Sometimes developer wants
              to launch a cluster of NodeJS process to take advantage of the
              multi-core system.
            </p>
          </article>
        </div>
